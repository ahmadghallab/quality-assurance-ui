<template>
    <ul class="pr-0">
        <li class="mb-3">
            <router-link class="circle circle-lg primary-highlight" :to="{name: 'home'}">
        ...
        <li class="mb-3">
            <router-link class="circle circle-lg primary-highlight" :to="{name: 'management'}">
        ...
        <li>
            <router-link class="circle circle-lg primary-highlight" :to="{name: 'criterion'}">
